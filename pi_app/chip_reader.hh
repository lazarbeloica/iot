...
public:
    ...
    virtual bool measure() const = 0;
    virtual const int extractTemperature() const = 0;
    virtual const int extractHumidity() const = 0;
    virtual const int extractPresure() const = 0;
};